...
parentdir = os.path.dirname(currentdir) + '/lnd'
...
def background_thread():
    ...
    count = 0
    while True:
        intercomStub = lnd.stub()
        my_pubkey = intercomStub[0].GetInfo(ln.GetInfoRequest(), metadata=[('macaroon', lnd.macaroon())]).identity_pubkey   
        ...
        socketio.emit('my_response',
                        {'data': 'LND pubkey: ' + my_pubkey, 'count' : count})
